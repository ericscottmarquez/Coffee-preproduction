...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_common_js__ = __webpack_require__(/*! vue/dist/vue.common.js */ 4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_resource__ = __webpack_require__(/*! vue-resource */ 8);



__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_common_js___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_resource__["a" /* default */]);

document.addEventListener('turbolinks:load', function () {
  __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_common_js___default.a.http.headers.common['X-CSRF-Token'] = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
    ...
    var app = new __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_common_js___default.a({
      ...
      methods: {
        ...
        saveTeam: function saveTeam() {
          ...
          if (this.id == null) {
            this.$http.post('/teams', { team: this.team }).then(function (response) {
            ...
            this.$http.put('/teams/' + this.id, { team: this.team }).then(function (response) {
              Turbolinks.visit('/teams/' + response.body.id);
            }, function (response) {
              console.log(response);
            });
...
/***/ })
/******/ ]);
//# sourceMappingURL=projekt-363c28986064faf44f0c.js.map